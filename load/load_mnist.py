...
config_file = open(os.path.join(os.path.dirname(os.getcwd()), "config", "config.cfg"))
...
if data_set_to_load == "1"  or data_set_to_load == "0":
    ...
    print("==============================================")
    train_object = gzip.open(str(os.path.join(os.path.dirname(os.getcwd()), "data", "train-images-idx3-ubyte.gz")), mode='rb')
...
if data_set_to_load == "2" or data_set_to_load == "0":
    ...
    train_image_labels_gzip = gzip.open(os.path.join(os.path.dirname(os.getcwd()), "data", "train-labels-idx1-ubyte.gz"), mode="rb")
    ...
    train_labels_pkl_file = open(os.path.join(os.path.dirname(os.getcwd()),"data","train_label_pkl.pkl"), mode="wb" )
