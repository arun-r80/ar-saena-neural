...
class Neural_2(neural_network.Neural):
    def __init__(self, training_data, no_of_neural_layers, no_of_training_set_members=60000, eta=0.0001):
        """
    ...
    #     """
    #     Evaluate output of an epoch's run, with given weights and biases.
    ...
    def train(self, epochs=10):
            ...
            for i in range(self.epochs):
                ...
                self._backward_propagate__(self.X, self.Y)
                print("J", self.J, end=" ")
                rate = self._evaluate()
